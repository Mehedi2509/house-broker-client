...
const TestimonialCard = () => {
    return (
        <div className="testimonial-card style-1 flex flex-col gap-6 px-12 py-[42px] xs:p-8 rounded-20px shadow-[0px_10px_40px_0px_rgba(0,0,0,0.02)] bg-white max-w-[500px]">
